...
function draw(p5s) {
  ...
  for (var i = 0; i < lineCount; i++) {
    ...
    var cx1 = x1 + 50 * (i - lineCount / 3) * Math.sin(deg);
    var cy1 = y1 + 200 * (i - lineCount / 3) * Math.sin(deg);

    var cx2 = x2 + 50 * (i - lineCount / 3) * Math.cos(deg);
    var cy2 = y2 + 200 * (i - lineCount / 3) * Math.cos(deg);
