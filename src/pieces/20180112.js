...
function draw() {
  ...
  for (var i = 0; i < lineCount; i++) {
    ...
    var x1 = margin + spacing * n + 100 * sin(deg);
    var y1 = margin + 100 * cos(deg);
    var x2 = margin + spacing * n;
    var y2 = margin + CANVAS.height / 2;

    var cx1 = x1 + 200 * (n % 2 ? 1 : -1) * sin(deg);
    var cy1 = y1 + 200 * (n % 2 ? 1 : -1) * cos(deg);
    
    var cx2 = x2 + 200 * (n % 2 ? 1 : -1)  * sin(deg);
    var cy2 = y2 + 200 * (n % 2 ? 1 : -1)  * cos(deg);
